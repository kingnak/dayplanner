...
mkdir "%QT5DEST%\qml"
mkdir "%QT5DEST%\qml\QtQuick"
xcopy /E /C /Y /I /Q "%QT5SRC%\qml\QtQuick\Controls" "%QT5DEST%\qml\QtQuick\Controls"
xcopy /E /C /Y /I /Q "%QT5SRC%\qml\QtQuick\Controls.2" "%QT5DEST%\qml\QtQuick\Controls.2"
xcopy /E /C /Y /I /Q "%QT5SRC%\qml\QtQuick\Layouts" "%QT5DEST%\qml\QtQuick\Layouts"
xcopy /E /C /Y /I /Q "%QT5SRC%\qml\QtQuick\Templates.2" "%QT5DEST%\qml\QtQuick\Templates.2"
xcopy /E /C /Y /I /Q "%QT5SRC%\qml\QtQuick\Window.2" "%QT5DEST%\qml\QtQuick\Window.2"

mkdir "%QT5DEST%\qml\QtQuick.2"
copy /Y "%QT5SRC%\qml\QtQuick.2\plugins.qmltypes" "%QT5DEST%\qml\QtQuick.2\"
copy /Y "%QT5SRC%\qml\QtQuick.2\qmldir" "%QT5DEST%\qml\QtQuick.2\"
copy /Y "%QT5SRC%\qml\QtQuick.2\qtquick2plugin.dll" "%QT5DEST%\qml\QtQuick.2\"
