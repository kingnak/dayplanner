...
public:
	...
	virtual RecipeTemplateDAO *loadRecipeTemplate(qint32 templateId) = 0;
	virtual RecipeTemplateDAO *createRecipeTemplate() = 0;
	virtual bool removeRecipeTemplate(qint32 recipeTemplateId) = 0;
